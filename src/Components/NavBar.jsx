  ...
  constructor(props) {
    ...
    this.state = {
      ...
      Admin: [
        ...
        {
          name: "View Student Degree Audit Pt1",
          onClick: () => this.makeForm(["studentID"], this.props.degreeAuditPt2),
        },
...

        {
          ...
          onClick: () => this.makeForm(["studentID"], this.props.viewStudentTranscript),
        },
      ],
      ...
      Faculty: [
...

        {
          ...
          onClick: () => {
            this.props.facultyCoursesTeaching()
          },
        },
...

        {
          ...
          onClick: () =>
            this.makeForm(["studentID", "crn", "isPresent", "date"], this.props.recordAttendance),
        },

        {
          name: "Student History",
          onClick: () => this.makeForm(["studentID"], this.props.studentHistory),
        },
